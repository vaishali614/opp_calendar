...
export class HackItem extends Component {
    getStyle = () => {
        return {
            backgroundColor: '#f4f4f4',
            padding: '10px',
            // borderBottom: '1px #ccc dotted',
            textDecoration: this.props.hackItem.completed ? 'line-through' : 'none'
        }
    }

    render() {
        const {url, duration, deadline, location, title} = this.props.hackItem;
        return (
                        ...
                        <div className="row no-gutters">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <div>
                                        <p className="card-text text-muted">Duration <span style={{color: 'red'}}>{duration}</span></p> 
